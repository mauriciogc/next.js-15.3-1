...
| Archivo `layout.tsx`                                         | <ul><li>¿Qué es `layout.tsx`?</li><li>Principales características</li><li>Ventajas</li><li>¿Cómo se crea o implementa?</li><li>¿Cómo funciona?</li><li>Ejemplos</li><li>A considerar</li></ul>                           | Medium                                                                                           | [Github](https://github.com/mauriciogc/next.js-15.3-1/tree/layout)        |
...
| Componente `Link`                                            | <ul><li>¿Qué es `Link`?</li><li>Características</li><li>Ventajas</li><li>¿Cómo se crea o implementa?</li><li>¿Cómo funciona?</li><li>Opciones disponibles</li><ul><li>`herf`</li><li>`Replace`</li><li>`prefetch`</li><li>`scroll`</li><li>`onNavigate`</li></ul><li>Ejemplos</li><li>A considerar</li><li>¿Es compatible usar `Link` dentro de `Layouts`?</li><li>Comparación con `a` tradicional</li></ul> | Medium\*                                                                                          | [Github](https://github.com/mauriciogc/next.js-15.3-1/tree/layout)                        |
