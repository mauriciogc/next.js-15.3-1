...
| Archivo `layout.tsx`<br/>_**Nota**: Revisar el componente `Link`_ | <ul><li>¿Qué es `layout.tsx`?</li><li>Principales características</li><li>Ventajas</li><li>¿Cómo se crea o implementa?</li><li>¿Cómo funciona?</li><li>Ejemplos</li><li>A considerar</li></ul>                           | [Medium](https://medium.com/@mauriciogc/next-js-componente-link-d0b60a91e0b8)                    | [Github](https://github.com/mauriciogc/next.js-15.3-1/tree/layout)        |
